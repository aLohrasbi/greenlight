...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "865f9260cc1be9", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "a6ee6e92f008d8", "SMTP password")
